    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='rental.invoice')),
            ],
        ),
        migrations.CreateModel(
            name='Rental',
        ...
        migrations.AddField(
            model_name='invoice',
            name='rental',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rental.rental'),
        ),
    ]
